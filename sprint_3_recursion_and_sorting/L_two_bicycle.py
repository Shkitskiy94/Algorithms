...
Формат ввода
В первой строке дано число дней n, по которым велись
наблюдения за Васиными накоплениями. 1 ≤ n ≤ 106.
...
price = int(input())
print(binary_search_bicycle(money, price, left=0, right=days),
      binary_search_bicycle(money, price * 2, left=0, right=days))
